class Objectt
  ...
  def initialize(id, word, brief_desc, long_desc)
    puts "DEBUGI Object initialize called '#{brief_desc}'"
...
def make_world_key(world)
  obj = Objectt.new(world.new_id, "key", "an unobtrusive key", "This unremarkable key seems to be made of iron.")
